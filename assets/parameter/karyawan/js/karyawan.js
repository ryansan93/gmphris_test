var karyawan = {
	...
	add_form : function () {
		$.get('parameter/Karyawan/add_form',{
        },function(data){
            var _options = {
                className : 'veryWidth',
				message : data,
	...
	set_disable_by_jabatan : function (elm, tipe = null) {
		...
		if ( !empty(jabatan) && jabatan != "" ) {
			karyawan.set_atasan(jabatan, tipe);
		} else {
	...
	set_atasan : function (jabatan, tipe=null) {
		...
		$.ajax({
            url : 'parameter/Karyawan/get_atasan',
	...
	modalGaji : function (elm) {
		var nik = $(elm).data('nik');
		$.get('parameter/Karyawan/modalGaji',{
			'nik' : nik
        },function(data){
            var _options = {
                className : 'veryWidth',
