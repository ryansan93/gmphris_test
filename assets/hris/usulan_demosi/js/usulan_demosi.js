...
let up ={
    ...
    load_form : () => {
        ...
        $.ajax({
            url : 'hris/UsulanDemosi/load_form',
            data : params,
            type : 'POST',
            dataType : 'html',
            beforeSend : function(){ 
    ...
    filter_data: () => {
        ...
        $.ajax({
            url : 'hris/UsulanDemosi/filter_data',
            data : params,
            type : 'POST',
            dataType : 'html',
            beforeSend : function(){ 
    ...
    set_jabatan: (elm, e, kolom) => {
        ...
        if (data.id_karyawan){
            ...
            $.ajax({
                url : 'hris/UsulanDemosi/get_unit_wilayah_json',
                data : data,
                type : 'POST',
                dataType : 'json',
                beforeSend : function(){ 
    ...
    show_detail : (elm, e) => {
        ...
        $.ajax({
            url : 'hris/UsulanDemosi/show_detail',
            data : params,
            type : 'POST',
            dataType : 'html',
            beforeSend : function(){ 
                    ...
                    if (params.status == 1 && is_edit == 1) {
                        ...
                        dialog.find('.btn-edit').on('click', function () {
                            window.location.href =
                                "hris/UsulanDemosi/edit_data?kode=" + params.kode;
                        });
                    }
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                bootbox.alert(data.message, function () {
                    ...
                    // up.load_form();
                    window.location.href = "hris/UsulanDemosi";
                });
            },
        });
    ...
    exec_keputusan:(kode, val, keterangan = null, tgl_berlaku = null) => {
        ...
        $.ajax({
            url : 'hris/UsulanDemosi/keputusan',
            data : params,
            type : 'POST',
            dataType : 'json',
            beforeSend : function(){ 
