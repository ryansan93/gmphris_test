let report = {
    ...
    load_data : (elm, e) => {
        ...
        $.ajax({
            url: 'hris/ReportKaryawanResign/load_data',
            method: 'POST',
            // data: { load_empty: 1 },
            dataType: 'html',
            success: function(r){
    ...
    filter_list : () => {
        ...
        $.ajax({
            url: 'hris/ReportKaryawanResign/filter_data',
            method: 'POST',
            data: params,
            dataType: 'html',
            beforeSend: function(){
    ...
    show_detail_data: (elm, e) => {
        ...
        $.ajax({
            url: 'hris/ReportKaryawanResign/show_detail_data',
            method: 'POST',
            data: params,
            dataType: 'html',
    ...
    export_excel: () => {
        ...
        window.location.href = 'hris/ReportKaryawanResign/export_excel?' + query;
    },
}
