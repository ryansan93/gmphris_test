				...
				<table class="table table-bordered table-hover" style="margin-bottom: 0px; max-width: 100%; width: 150%;">
					<thead>
						<tr>
							...
							<th class="text-center col-xs-1">Kode Trans</th>
							<th class="text-center col-xs-1">Noreg</th>
							<th class="text-center col-xs-1">Plasma</th>
							<th class="text-center col-xs-1">Terima (Box)</th>
							<th class="text-center col-xs-1">Tercatat (Box)</th>
							<th class="text-center col-xs-1">Selisih (Box)</th>
