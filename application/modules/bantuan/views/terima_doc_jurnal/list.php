<?php if (!empty($data)) { ?>
    ...
    <?php foreach ($data as $k => $val) : ?>
        <tr>
            ...
            <td class="text-left"><?php echo $val['noreg']; ?></td>
            <td class="text-left"><?php echo $val['nama_mitra']; ?></td>
            <td class="text-right col-xs-1"><?php echo angkaRibuan($val['jml_terima'] / 100); ?></td>
            <td class="text-right col-xs-1"><?php echo angkaRibuan($val['jml_stok'] / 100); ?></td>
            <td class="text-right col-xs-1"><?php echo angkaRibuan($val['selisih'] / 100); ?></td>
