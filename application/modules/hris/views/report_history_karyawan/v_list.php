        ...
        <?php if (!empty($list)) { ?>
            ...
            <?php foreach($list as $l){?>
                ...
                <tr class="data-row">
                    ...
                    <td class="text-center" style="white-space:nowrap;"><?php echo tglIndonesia($l['tgl_mulai'], "-" , " ") ?></td>
                    <td class="text-center" style="white-space:nowrap;"><?php echo !empty($l['tgl_selesai']) ? tglIndonesia($l['tgl_selesai'], "-", " ") : '-' ?></td>
                    <td>
                        <?php 
                            $key = "secretkey";
                            $plaintext = $l['kode'];
                        ...
                        <?php if ($l['status'] == 2 || $l['status'] == 3 ){?>
                            <button class="btn btn-info" onclick="window.open('hris/ReportHistoryKaryawan/print_preview?kode=<?= $encrypted ?>','_blank')"><i class="fa fa-print"></i></button>
                        <?php } ?>
                    </td>
