        ...
        <tr class="tr_loop">
            ...
            <td style="text-align:center">
                <?php if ($p['status'] == 'DRAFT' ) { ?>
                    <button nik="<?php echo $p['nik']?>" id_penilaian="<?php echo $p['id']?>" onclick="kpi.edit_penilaian(this, event)" class="btn btn-warning"><i class="fa fa-edit"></i></button>
                    <button nik="<?php echo $p['nik']?>" id_penilaian="<?php echo $p['id']?>" onclick="kpi.delete_penilaian(this, event)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                <?php } else { ?>
                    -
                <?php } ?>
