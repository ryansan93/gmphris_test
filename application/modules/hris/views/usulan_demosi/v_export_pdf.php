					...
					<div class="col-xs-12 head" style="display: inline-block; text-align: left;">
						<table class="col-xs-12">
							<tbody>
								<tr>
									<td colspan="2">
										<label class="col-xs-12" style="font-size: 18pt; display: inline-block; margin-bottom: 10px; text-decoration: underline"><b>USULAN DEMOSI KARYAWAN</b></label>
									</td>
								</tr>
								<tr>
									...
									<td class="col-xs-6" style="vertical-align: top; font-size: 10pt;">
										<div class="col-xs-12" style="display: inline; text-align: left;">
											...
											<label style="display: inline-block; width: 75.5%;"><?php echo strtoupper($data['kode']); ?></label>
										</div>
										<div class="col-xs-12" style="display: inline; text-align: left;">
											<label style="display: inline-block; width: 18%;">Tanggal</label>
											<label style="display: inline-block; width: 2%;">:</label>
											<label style="display: inline-block; width: 75.5%;"><?php echo strtoupper(tglIndonesia(substr($data['tanggal'], 0, 10), '-', ' ')); ?></label>
										</div>
										<!-- <div class="col-xs-12" style="display: inline; text-align: left;">
					...
					<div class="col-xs-12" style="display: inline-block; text-align: left; font-size: 10pt;">
						<table class="border-field" style="width: 100%;">
							...
							<tbody>
								...
								<tr>
									<th class="text-left" style="width: 1%;"><span style="margin-left:15px;" >Jenis </span></th>
									<th class="text-left" style="width: 10px;">:</th>
									...
									<th class="text-center" colspan="3">
										...
										<div style="margin:10px; width:97%; ">
											...
											<div style="display:flex;">
												<div style="border:1px solid black; padding:5px; flex:1; text-align:center; background-color:#E6E6E6;">
													Jabatan Asal
												</div>
											...
											<div style="display:flex; justify-content:center; align-items:stretch; height:auto;">
												...
												<div style="border:1px solid black; padding:5px; flex:1; text-align:left; display:flex; flex-direction:column; justify-content:center;">
													...
													<div style="display:flex; flex-direction:row;">
														...
														<span><?php echo $nama_wilayah_asal;?></span>
													</div>

													<div style="display:flex; flex-direction:row;">
														<span style="width:100px;">Unit</span>
														<span style="width:20px;">:</span>
														<span><?php echo $nama_unit_asal;?></span>
													</div>
								...
								<tr>
									...
									<th class="text-left" style="width: 10px;">:</th>
									<th class="text-left" style="width: 5%;"><?php echo $data['alasan']?> [<?php echo $data['tgl_berlaku']?>]</th>
								</tr>
