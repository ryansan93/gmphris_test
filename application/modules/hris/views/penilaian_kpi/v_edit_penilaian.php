                ...
                <?php foreach ($detail as $b) { ?>
                    ...
                    <tr class="tr_loop" kode_index="<?= $b['kode_index']; ?>">
                        ...
                        <td style="width:100px;">
                            <input type="number" value="<?php echo number_format($b['nilai']) ?>" class="form-control nilai text-right" max="100" oninput="if(this.value > 100) this.value = 100;" onchange="kpi.hitungScore(this)">
                        </td>
