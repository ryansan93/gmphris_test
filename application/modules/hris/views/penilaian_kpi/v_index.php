    ...
    <div class="tab-content">
        ...
        <div id="list_data" class="tab-pane fade in active">
            ...
            <fieldset>
                ...
                <div style="display:flex; gap:4px;">
                    ...
                    <button onclick="penilaian.downloadTemplatePenilaian(this, event)" class="btn-xls">
                        <i class="fa fa-download" aria-hidden="true"></i> Download Template
                    </button>
                    <button onclick="penilaian.importXlsPenilaian(this, event)" class="btn-xls">
        ...
        <div id="action" class="tab-pane fade">
            ...
            <fieldset style="margin-bottom: 15px;">
                ...
                <div class="col-xs-12 no-padding notifContain">
                    ...
                    <div style="display:flex; flex-direction:column;">
                        ...
                        <select name="bulan" class="select2 bulan" onchange="penilaian.getPeriode();">
                    ...
                    <div style="display:flex; flex-direction:column;" class="select-penilai">
                        ...
                        <select class="select2 penilai" id="penilai" onchange="penilaian.getPeriode(this, event)">
                    ...
                    <div style="display:flex; flex-direction:column;" class="select-karyawan">
                        ...
                        <select class="select2 karyawan" id="karyawan" onchange="penilaian.loadDataBobot(this, event)" disabled>
            ...
            <div style="display:flex; flex-direction; justify-content:right; align-items:center; gap:10px;">
                ...
                <button class="btn btn-primary" onclick="penilaian.save(this, event)">Simpan</button>
            </div>
        </div>
