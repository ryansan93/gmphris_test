        ...
        <div class="panel-body">
            ...
            <div style="display:flex; flex-direction:column; gap:10px;">
                ...
                <div style="display:flex; flex-direction:row;">
                    ...
                    <span style="width:50px;">:</span>
                    <input type="text" class="jabatan_tujuan form form-control data_edit" value="<?php echo $data_edit['jabatan_tujuan'] ?> " disabled>
                </div>
                    ...
                    <div style="display:flex; flex-direction:row; gap:10px; margin-left:6px;">
                       <?php
                        ...
                        <div style="display:flex; flex-direction:column;">
                            ...
                            <select class="select2 perwakilan_tujuan select_multiple" name="perwakilan_tujuan[]" multiple="multiple"  >
