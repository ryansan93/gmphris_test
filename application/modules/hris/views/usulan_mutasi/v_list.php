<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th class="text-center">Jabatan Pengusul</th>
                ...
                <tr class="data-row" style="<?php echo !empty($l['selected']) ? 'background-color: #FFF9D6;' : '' ?>" > 
                    ...
                    <td class="text-center" style="white-space:nowrap;">
                        ...
                        <?php if ($l['status'] == 2 || $l['status'] == 3 ){?>
                            <button class="btn btn-info" onclick="window.open('hris/UsulanMutasi/print_preview?kode=<?= $encrypted ?>','_blank')"><i class="fa fa-print"></i></button>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
