        ...
        <?php foreach ($data_periode as $row) { ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button class="btn btn-secondary btn-sm" bobot="<?php echo number_format($row['bobot'], 0) . '%' ?>" index="<?php echo $row['nama_kpi'] ?>" onclick="home.detail_chart_periode(this, event)">Detail</button>
                </td>
                        ...
                        <?php foreach($row['data_penilaian'] as $dt) { ?>
                            <div style="display:flex; flex-direction:row; gap:10px; border-radius:5px; border:1px solid #D6D6D6; padding: 10px;">
                                <div style="display:flex; flex-direction:column; width:40%;">
                                    ...
                                    <span style="font-size:15px;"><?php echo ucwords(strtolower($dt['nama'])) ?></span>
                                </div>
