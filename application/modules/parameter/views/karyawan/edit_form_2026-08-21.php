...
<div class="modal-body body">
	<div class="row">
		...
		<div class="col-lg-12 no-padding">
			<div class="col-lg-12">
				<button type="button" class="btn btn-primary cursor-p pull-right" onclick="karyawan.edit(this)" data-id="<?php echo $data['id']; ?>" data-nik="<?php echo $data['nik']; ?>" ><i class="fa fa-edit"></i> Update</button>
			</div>
		</div>
	</div>
</div>