<div class="modal-header header">
	<span class="modal-title">Add Periode Fiskal</span>
				...
				<div class="form-group d-flex align-items-center">
					<div class="col-lg-12">
						<label class="checkbox-inline">
							<input type="checkbox" value="1" class="status cursor-p"><label class="control-label" style="margin-top: 0xp; padding-top: 0px;">Aktif</label>
						</label>
					</div>
				</div>
			</form>
		...
		<div class="col-lg-12">
			<form role="form" class="form-horizontal">
				<div class="form-group pull-right">
					<div class="col-lg-2">
						<button type="button" class="btn btn-primary cursor-p" onclick="pf.save();"><i class="fa fa-save"></i> Simpan</button>
					</div>
				</div>
			</form>
		</div>
