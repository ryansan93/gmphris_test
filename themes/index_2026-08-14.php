...
<head>
  ...
  /* tampil saat dibuka (BS3 = .open, BS4 = .show) */
  ...
  /* Kulit dropdown notifikasi & user */
  ...
  /* ============================================
     ...
     (ditaruh PALING AKHIR supaya menang)
     ============================================ */
...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light-black" id="sidebar-wrapper" style="width: 17rem;">
      <div class="sidebar-heading">
        <b>GMP HRIS</b>
        <br>
        <small>PT. Griya Mitra Poultry</small>
      </div>
            ...
            <li>
              ...
              <ul class="collapse list-unstyled" id="<?php echo $v_fitur['id_header_fitur'] ?>">
                <?php foreach ($v_fitur['detail'] as $key => $v_mdetail): ?>
                    <li class="menu">
                      <a href="<?php echo $v_mdetail['path_detfitur']; ?>" class="list-group-item list-group-item-action bg-light-black menu" data-txt="<?php echo htmlspecialchars($v_mdetail['nama_detfitur'], ENT_QUOTES); ?>">
  ...
  <script>
    $(function(){
      ...
      // Klik link menu — batalkan request AJAX yang sedang berjalan (jika ada)
      ...
      // Custom scrollbar sidebar (kalau plugin tersedia)
